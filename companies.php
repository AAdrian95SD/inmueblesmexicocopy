...
$inmobiliarias = $controller->getInmobiliariasbyEstadov2($_GET['tab']);

if (count($inmobiliarias) == 1) {
    
    $_SESSION['company'] = $inmobiliarias[0][0];    
    header("location:propiedades.php");
    
} else if (count($inmobiliarias) > 1) {
...
<html lang="en">
    ...
    <body oncontextmenu="return false">
        ...
        <div id="wrapper"> 
            ...
            <!-- Banner -->
            <!-- Banner -->
            <div class="parallax" data-background="about/img/first1.jpg" data-color="#36383e" data-color-opacity="0.7" data-img-width="2500" data-img-height="1600">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="search-container"> 
                                <form action="propiedades.php" method="post" name="post_propiedades">
                                    ...
                                    <div class="row with-forms"> 
                                        <!-- Select City -->
                                        <div class="col-md-2">
                                            <select data-placeholder="Select City" title="Select City" name="tab" class="utf-chosen-select-single-item">
                    ...
                    <div class="row">
                        <div class="col-md-12"> 
                            <div class="utf-section-headline-item centered margin-bottom-30 margin-top-0">
                                <h3 class="headline"><span>Inmobiliarias en <?php print $inmobiliarias[0][11]; ?> </span></h3>
                                <div class="utf-headline-display-inner-item">Nuestros socios bienes raíces</div>
                                <p class="utf-slogan-text"><span>Seleccione una agencia de bienes raíces...</span></p>
                            </div>  
                        </div>
                        <div class="col-md-12">
                            <div class="carousel"> 
                                ...
                                foreach ($inmobiliarias as $elemento) {
                                    ...
                                    print ' <div class="agent agents-profile agency">
                                    ...
                                    <div id="logo"> <a class=""><img src="' . $elemento[7] . '" alt=""></a> </div>
                                      ...
                                      <div class="utf-agent-name">
                                        ...
                                        <h4><a target="blank" href="propiedades.php?tab=0&type=0&companie=' . $elemento[0] . '">' . $elemento[1] . '</a></h4>
                                        <ul class="utf-agent-contact-details">
                                                        <li><i class="icon-material-outline-business"></i>' . $elemento[11] . '</li>
                                                            <li><i class="icon-feather-smartphone"></i>' . $elemento[3] . '</li>
            ...
            <section class="fullwidth" data-background-color="#ffffff">
                <div class="container">
                    ...
                    <div class="utf-centered-button margin-top-10">
                        <a href="propiedades.php" class="button">Ver todos los inmuebles</a> 
                    </div>
                </div>
            </section>
