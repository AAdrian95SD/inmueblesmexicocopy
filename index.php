...
<body oncontextmenu="return false">
    ...
    <div id="wrapper">
            ...
            <div id="header" style="background: #ffffff;">
                <div class="container">
                    ...
                    <div class="left-side">
                        ...
                        <!-- Main Navigation -->
                        <nav id="navigation" class="style-1" style="background: #ffffff;">
                            <ul id="responsive">
                                <li><a class="current" href="#" style="color:#18253e; font-size:18px">Inicio</a></li>
                                <li><a href="conocenos.php" style="color: #18253e; font-size:18px">Conócenos</a></li>
                                <li><a href="#footer" style="color: #18253e; font-size:18px">Contacto</a></li>
                                <li><a target="_blank" href="https://precalificaciones.infonavit.org.mx/Precalificacion/precalif.xhtml?tipoProducto=CI" style="color: #18253e; font-size:18px">Precalificate</a></li>
                                <li><a href="login.php" style="color: #18253e; font-size:18px">Entrar</a></li>
                                <li><a href="crear-usuario.php" style="color: #18253e; font-size:18px">Registrarme</a></li>
                            </ul>
                        </nav>
        ...
        <!-- Banner -->
        <!-- Banner -->
        <div class="parallax" data-background="images/fondo_buscador.jpg" data-color="#36383e" data-color-opacity="0.1" data-img-width="2500" data-img-height="1600">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="search-container">
                            <form action="propiedades.php" method="post" name="post_propiedades">
                                <h2></h2>
                                <div class="announce">
                                    <p style="color: #00283a; font-weight: bold;"></p>
                                </div>
                        ...
                        <div class='search-container'>
                            <div class="row">
                                ...
                                <ul class="utf-home-iconbox">
                                    <li class="list-inline-item" onclick="myRedirect('propiedades.php', 'type', 'Casa en condominio');">
                                        <div style="height:40px;" class="icon"><span class="icon-line-awesome-building"></span>
                                            <p>Condominios</p>
                                        </div>
                                    </li>
                                    <li class="list-inline-item" onclick="myRedirect('propiedades.php', 'type', 'Casa');">
                                        <div class="icon"><span class="icon-feather-home"></span>
                                            <p>Casa</p>
                                        </div>
                                    </li>
                                    <li class="list-inline-item" onclick="myRedirect('propiedades.php', 'type', 'Comercial');">
                                        <div class="icon"><span class="icon-material-outline-location-city"></span>
                                            <p>Comercial</p>
                                        </div>
                                    </li>
                                    <li class="list-inline-item" onclick="myRedirect('propiedades.php', 'type', 'Departamento');">
                                        <div class="icon"><span class="icon-material-outline-business"></span>
                                            <p>Departamento</p>
                                        </div>
                                    </li>
                                </ul>
        ...
        <div class="parallax" data-background="images/background_azul.jpg" data-color="#36383e" data-color-opacity="0.0" data-img-width="1800" data-img-height="1600">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="search-container">
                            <form action="" method="post" name="post_propiedades">
                                <h2><span style="color: #023047" ;>Encuentra los</span> mejores lugares <span style="color: #023047" ;>para vivir en México</span> </h2>
                                <div class="announce">
                                    <p style="color: #ffffff; font-weight: bold;">Elije una de nuestras propiedades de nuestra gran variedad de bienes raíces, no solo encontrarás casas, también tenemos bodegas, oficinas y terrenos</p>
                                    <p style="color: #023047; font-weight: bold;">¡El inmueble que siempre buscaste lo encontrás aquí!</p>
                                </div>
                                <div class="row with-forms">
                                </div>
                                <div class="row">
                                    <ul class="utf-home-iconbox">
                                        <button class="button" type="submit">Comienza a buscar ahora</button>
                                    </ul>
                                </div>
                            </form>
                        </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6">
                        ...
                        <ul class="utf-home-iconbox">
                            <a href="companies.php?tab=1&type=0"><button style="background:yellowgreen; color: #ffffff; font-weight: bold; font-size:large; width: 200px; border-radius: 30px;" class="button">Morelos</button></a>
                        </ul>
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <a class="img-box">
                        ...
                        <ul class="utf-home-iconbox">
                            <a href="companies.php?tab=2&type=0"><button style="background:yellowgreen; color: #ffffff; font-weight: bold; font-size:large; width: 200px; border-radius: 30px;" class="button">Jalisco</button></a>
                        </ul>
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <a class="img-box">
                        ...
                        <ul class="utf-home-iconbox">
                            <a href="companies.php?tab=3&type=0"><button style="background:yellowgreen; color: #ffffff; font-weight: bold; font-size:large; width: 200px; border-radius: 30px;" class="button">Chiapas</button></a>
                        </ul>
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <a class="img-box">
                        ...
                        <ul class="utf-home-iconbox">
                            <a href="companies.php?tab=27&type=0"><button style="background:yellowgreen; color: #ffffff; font-weight: bold; font-size:large; width: 200px; border-radius: 30px;" class="button">S.L.P</button></a>
                        </ul>
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <a class="img-box">
                        ...
                        <ul class="utf-home-iconbox">
                            <a href="ompanies.php?tab=11&type=0"><button style="background:yellowgreen; color: #ffffff; font-weight: bold; font-size:large; width: 200px; border-radius: 30px;" class="button">Chihuahua</button></a>
                        </ul>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-6">
                        ...
                        <ul class="utf-home-iconbox">
                            <a href="companies.php?tab=24&type=0"><button style="background:yellowgreen; color: #ffffff; font-weight: bold; font-size:large; width: 200px; border-radius: 30px;" class="button">Puebla</button></a>
                        </ul>
                    </div>
                ...
                <div class="utf-centered-button margin-top-50">
                    <!-- <a href="propiedades.php?res=1" class="button">Ver todos los inmuebles</a>-->
                    <a href="propiedades.php?res=1"><button style="background:yellowgreen; color: #ffffff; font-weight: bold; font-size:large; width: 200px; border-radius: 30px; left:450px;" class="button">Ver más</button></a>
                </div>
            </div>
        </section>
        ...
        <div class="parallax" data-color="#ffffff" data-color-opacity="0.1" data-img-width="2500" data-img-height="1600">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="search-container">
                            <form action="" method="post" name="post_propiedades">
                                <h2 style="color: #000000; font-weight: bold;">¿Quieres anunciarte?</h2>
                                <div class="announce">
                                    <p style="color: #ffffff; font-weight: bold;">Prueba ahora nuestros planes</p>
                                    <p style="color: #023047; font-weight: bold;">Vende tu inmueble, ¡Garantizado!</p>
                                </div>
                                <div class="row with-forms">
                                </div>
                                <div class="row">
                                    <ul class="utf-home-iconbox">
                                        <a href=""><button style="background:yellowgreen; color: #ffffff; font-weight: bold; font-size:large; width: 300px; border-radius: 30px;" class="button">Conoce tu plan ideal</button></a>
                                    </ul>
                                </div>
                            </form>
                        </div>
        ...
        <div class="parallax" data-background="images/fondo_azul.png" data-color="#36383e" data-color-opacity="0.0" data-img-width="1800" data-img-height="1600">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="search-container">
                            <div class="col-md-4 col-sm-6">
                                <a class="img-box">
                                    <img src="images/logo_inmuebles2.png" alt="" />
                                </a>
                                <div class="row with-forms">
                                    <p style="color: #ffffff; font-weight: bold;">Quiénes somos</p>
                                    <p style="color: #ffffff; font-weight: bold;">Política de privacidad</p>
                                    <p style="color: #ffffff; font-weight: bold;">Contacta con Inmuebles en México</p>                                    
                                </div>
                            </div>
                            <form action="" method="post" name="post_propiedades">
                                <h2>¿Quieres anunciarte con nosotros?</h2>
                                <div class="announce">
                                    <p style="color: #ffffff; font-weight: bold;">Publica tu anuncio como individual</p>
                                    <p style="color: #ffffff; font-weight: bold;">Publica como empresarial</p>
                                    <p style="color: #ffffff; font-weight: bold;">Publica como socio</p>                                    
                                </div>
                                <div class="row">
                                    <ul class="utf-home-iconbox">
                                        <a href=""><button style="background:yellowgreen; color: #ffffff; font-weight: bold; font-size:large; width: 300px; border-radius: 30px;" class="button">Registrate aqui</button></a>
                                    </ul>
                                </div>
                            </form>
                        </div>
