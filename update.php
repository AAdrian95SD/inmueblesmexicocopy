...
$propiedad = $controller->getdetailByID($_GET['propiedad']);
...
$municipios = $controller->getMunicipios($propiedad[0][9]);
                        ...
                        <form method="post" action="utils.php" autocomplete="off">
                            <div class="submit-page">
                                ...
                                <div class="utf-submit-page-inner-box">
                                    ...
                                    <input type="hidden" id="custId" name="id" value="<?php echo $_GET['propiedad']; ?>">
                                    <div class="content with-padding">             
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="utf-chosen-select-single-item" name="estatus">
                                                ...
                                                <option <?php if ($propiedad[0][2] == 'Venta') {
                    echo 'Selected';
                } ?> value="Venta">Venta</option>
                                                <option <?php if ($propiedad[0][2] == 'Renta') {
                    echo 'Selected';
                } ?> value="Renta">Renta</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="utf-chosen-select-single-item" name="tipo">
                                                <option label="blank"></option>
                                                <option <?php if ($propiedad[0][3] == 'Departamento') {
                    echo 'Selected';
                } ?>>Departamento</option>
                                                <option <?php if ($propiedad[0][3] == 'Casa') {
                    echo 'Selected';
                } ?>>Casa</option>
                                                <option <?php if ($propiedad[0][3] == 'Comercial') {
                    echo 'Selected';
                } ?>>Comercial</option>
                                                <option <?php if ($propiedad[0][3] == 'Terreno/Lote') {
                    echo 'Selected';
                } ?>>Terreno/Lote</option>
                                                <option <?php if ($propiedad[0][3] == 'Oficina') {
                    echo 'Selected';
                } ?>>Oficina</option>
                                                <option <?php if ($propiedad[0][3] == 'Casa en condominio') {
                    echo 'Selected';
                } ?>>Casa en condominio</option>
                                                <option <?php if ($propiedad[0][3] == 'Bodega') {
                    echo 'Selected';
                } ?>>Bodega</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select class="utf-chosen-select-single-item" name="cuartos">
                                                <option label="blank"></option>
                                                <option <?php if ($propiedad[0][6] == '1') {
                    echo 'Selected';
                } ?>>1</option>
                                                <option <?php if ($propiedad[0][6] == '0') {
                    echo 'Selected';
                } ?>>0</option>
                                                <option <?php if ($propiedad[0][6] == '2') {
                    echo 'Selected';
                } ?>>2</option>
                                                <option <?php if ($propiedad[0][6] == '3') {
                    echo 'Selected';
                } ?>>3</option>
                                                <option <?php if ($propiedad[0][6] == '4') {
                    echo 'Selected';
                } ?>>4</option>
                                                <option <?php if ($propiedad[0][6] == '5') {
                                                    echo 'Selected';
                                                } ?>>5</option>
                                                <option <?php if ($propiedad[0][6] == 'Mas de 5') {
                                                    echo 'Selected';
                                                } ?>>Mas de 5</option>
                                            </select>
                                        </div>
...
foreach ($estados as $estado) {
    $selected = '';
    if ($propiedad[0][9] == $estado[0]) {
        $selected = 'Selected';
    }
    print '<option ' . $selected . ' value="' . $estado[0] . '">' . $estado[1] . '</option>';
}
?>
                                            </select>
                                        </div>
                                        <div class="col-md-6">
                                            <h5>Código postal</h5>
                                            <input type="text" placeholder="000000" name="codigopostal" required 
                                                   value="<?php echo $propiedad[0][10]; ?>">
                                        </div>
                                        <div class="col-md-6">
                                            <h5>Calle</h5>
                                            <input type="text" placeholder="Dirección" name="calle" required 
                                                   value="<?php echo $propiedad[0][7]; ?>">
                                        </div>
                                        <div class="col-md-6">
                                            <h5>Municipio</h5>
...
foreach ($municipios as $municipio) {
    $selected = '';
    if ($propiedad[0][8] == $municipio[0]) {
        $selected = 'Selected';
    }
    print '<option ' . $selected . ' value="' . $municipio[0] . '">' . $municipio[1] . '</option>';
}
?>
                                            </select>
                                        </div>
                                ...
                                <div class="utf-submit-page-inner-box">
                                    ...
                                    <div class="content with-padding">             
                                        <div class="col-md-12">
                                            <h5>Descripción</h5>
                                            <textarea name="descripcion" cols="20" rows="2" id="summary" required>
<?php echo str_replace("<br>", "", $propiedad[0][11]); ?></textarea>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select class="utf-chosen-select-single-item" name="recamaras">
                                                <option label="blank"></option>
                                                <option <?php if ($propiedad[0][12] == '0') {
    echo 'Selected';
} ?>>0</option>
                                                <option <?php if ($propiedad[0][12] == '1') {
                                                    echo 'Selected';
                                                } ?>>1</option>
                                                <option <?php if ($propiedad[0][12] == '2') {
                                                    echo 'Selected';
                                                } ?>>2</option>
                                                <option <?php if ($propiedad[0][12] == '3') {
                                                    echo 'Selected';
                                                } ?>>3</option>
                                                <option <?php if ($propiedad[0][12] == '4') {
                                                    echo 'Selected';
                                                } ?>>4</option>
                                                <option <?php if ($propiedad[0][12] == '5') {
                                                    echo 'Selected';
                                                } ?>>5</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select class="utf-chosen-select-single-item" name="banos">
                                                <option label="blank"></option>
                                                <option <?php if ($propiedad[0][13] == '0') {
                                                    echo 'Selected';
                                                } ?>>0</option>
                                                <option <?php if ($propiedad[0][13] == '1') {
                                                    echo 'Selected';
                                                } ?>>1</option>
                                                <option <?php if ($propiedad[0][13] == '2') {
                                                    echo 'Selected';
                                                } ?>>2</option>
                                                <option <?php if ($propiedad[0][13] == '3') {
                                                    echo 'Selected';
                                                } ?>>3</option>
                                                <option <?php if ($propiedad[0][13] == '4') {
                                                    echo 'Selected';
                                                } ?>>4</option>
                                                <option <?php if ($propiedad[0][13] == '5') {
                                                    echo 'Selected';
                                                } ?>>5</option>
                                            </select>
                                        </div> 
...
foreach ($agentes as $field) {
    $selected = '';
    //var_dump($propiedad[0][14].'-'.$field[0]);
    if ($propiedad[0][14] == $field[0] . '') {
        $selected = "Selected";
    }

    print '<option ' . $selected . ' value="' . $field[0] . '">' . $field[1] . ' ' . $field[2] . '</option>';
}
?>
                                            </select>
                                        </div>
...
?>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="submit" class="button full-width border margin-top-10" name="submit" value="Editar" />
                                    </div>	
                                </div>
                            </div>
                        </form>
